...
<head>
    ...
    <title>Quên mật khẩu - GON SHOES</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Đừng lo lắng! Nhập email của bạn và chúng tôi sẽ gửi liên kết đặt lại mật khẩu.</p>
            </div>

            <?php if (isset($_SESSION['forgot_message'])): ?>
                <div class="alert alert-success">
                    <i class="fas fa-check-circle"></i>
                    <span><?= htmlspecialchars($_SESSION['forgot_message']) ?></span>
                </div>
            ...
            <?php if (isset($_SESSION['forgot_error'])): ?>
                <div class="alert alert-error">
                    ...
                    <span><?= htmlspecialchars($_SESSION['forgot_error']) ?></span>
                </div>
            ...
            <div class="auth-footer">
                <a href="/shoe-shop/public/login" class="back-link">
